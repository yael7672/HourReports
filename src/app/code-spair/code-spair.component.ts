...
//  קוד ספייר לTIME COUNTER
//  קוד ספייר לTIME COUNTER
//  קוד ספייר לTIME COUNTER
//  קוד ספייר לTIME COUNTER

@Component({
  selector: 'app-code-spair',
  templateUrl: './code-spair.component.html',
  styleUrls: ['./code-spair.component.css']
})

export class CodeSpairComponent implements OnInit {
